defmodule OrgtoolDb.Admin.SessionController do
  @moduledoc """
  ...
  """
  use OrgtoolDb.Web, :admin_controller
  ...
  # We've aliased Guardian.Plug.EnsureAuthenticated in our OrgtoolDb.Web.admin_controller macro
